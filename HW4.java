...
public class HW4 {
  //  private static Analyzer analyzer = new StandardAnalyzer(Version.LUCENE_47);
	...
	System.out.println("enter the file name containing all the given queries-format- absolute path");
	...
	for(String each_query: queryList) {
		...
		for (int i = 0; i < hits.length; ++i) {
		    ...
		    File file = new File("Ranking_Lucene.txt");
		    output = new BufferedWriter(new FileWriter(file,true));
		    output.write(j + " "+ "Q0"+ " " + f.getName() + " "+ (i+1)+ " " + hits[i].score + " " +"lucene");
		    output.newLine();
		    output.close();
		    System.out.println(j + " "+ "Q0"+ " " + f.getName() + " "+ (i+1)+ " " + hits[i].score + " " +"lucene" );
		}
